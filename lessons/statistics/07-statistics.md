...
P(ident|tw_br) = ((P(tw_br|ident) * P(ident)) / P(tw_br)

P(ident) = 1/300
P(tw_br|ident) = 1/2
P(tw_br) = P(tw_br|ident) + P(tw_br|frat) = 1/2 * 1/600 + 1/4 * 1/125 =
= 11/3000

 P(ident|tw_br) = (1/2 * 1/300) / (11/3000) = 5/11 ~ 0.46

 The probability that Elvis was an identical twin is about 46%.
...
Frequentists statistics applies probability to data, Bayesian - to data and hypotheses. Bayesian statistics requires prior distribution whereas Frequentist doesn't. Hence Bayesian can update results as new data come in. One of the challenges of Bayesian approach is its dependence of the choice of prior and computational complexity.
---
